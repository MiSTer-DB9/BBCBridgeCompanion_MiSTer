...
UPSTREAM_REPO="https://github.com/MiSTer-devel/BBCBridgeCompanion_MiSTer.git"
CORE_NAME=(BBCBridgeCompanion)
...
UPSTREAM_CORE_NAME=(BBCBridgeCompanion)
MAIN_BRANCH="main"
UPSTREAM_BRANCH="main"
COMPILATION_INPUT=(BBCBridgeCompanion.qpf)
COMPILATION_OUTPUT=(output_files/BBCBridgeCompanion.rbf)
